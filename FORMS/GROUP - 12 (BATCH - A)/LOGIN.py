...
mem0.grid(row = 1,column = 0,padx = (20,10),pady = 15)
...
mem1.grid(row = 2,column = 0,padx = (20,10),pady = 15)
...
mem2.grid(row = 3,column = 0,padx = (20,10),pady = 15)
mem22 = ctk.CTkLabel(frame2,text="14",font=ctk.CTkFont(family =  "Times New Roman" ,size=18,weight = "bold"))
