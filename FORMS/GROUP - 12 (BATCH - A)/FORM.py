...
user_info_frame.grid(row = 0,column = 0,columnspan = 2,padx = 50,pady = (10,1),sticky = "ew")
...
user_frame.grid(row = 1,column = 0,padx = (50,10),pady = (5,2.5),sticky = "ew")
...
address_frame.grid(row = 1,column = 1,padx = (10,50),pady = (5,2.5),sticky = "news")
...
course_frame.grid(row = 2,column =0,columnspan = 2,padx = 50,pady = 2.5,sticky = "ew")
...
terms_frame.grid(row = 3,column = 0,columnspan = 2,padx = 50,pady = 2.5,sticky = "news")
def open_html_file():
...
term_label.grid(row = 0,column = 0,pady=2)
...
terms_check.grid(row=1, column=0,pady=1)
...
button_frame.grid(row = 4,column = 0,columnspan = 2,padx = 50,pady = (2.5,5),sticky = "ew")
