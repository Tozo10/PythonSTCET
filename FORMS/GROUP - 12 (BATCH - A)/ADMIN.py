...
def toggle_access():
    ...
    if config["access_enabled"]:
        config["access_enabled"] = False
        enable_button.configure(text="Enable Access")
    else:
        config["access_enabled"] = True
        enable_button.configure(text="Disable Access")
...
frame.pack(fill = "x",padx = 85,pady = 5)
...
style.configure("Treeview",background = "#EBF8FF",fieldbackground ="#EBF8FF",foreground = "#264D61",rowheight = 18)
...
button_frame.grid(row = 3,column = 1,padx = (10,20),pady = (5,10),sticky = "news")
...
Edit_button.grid(row=0, column=0, padx=(10, 5), pady=10, sticky="ew")
...
Excel_button.grid(row=0, column=1, padx=(5, 5), pady=10, sticky="ew")

# Add buttons to enable and disable access
enable_button = ctk.CTkButton(button_frame, text="Disable Access", command=toggle_access,fg_color="#264D61",hover_color="#2F5E87",height = 30,corner_radius = 15)
enable_button.grid(row=0, column=2, padx=(5, 5), pady=10, sticky="ew")
...
remove_all_button.grid(row=0, column=3, padx=(5, 5), pady=10, sticky="ew")
...
remove_rows_button = ctk.CTkButton(button_frame, text="Remove Selected", command=remove_row,fg_color="#264D61",hover_color="#2F5E87",height = 30,corner_radius = 15)
remove_rows_button.grid(row=0, column=4, padx=(5, 5), pady=10, sticky="ew")
...
exit_button.grid(row=0, column=5, padx=(5, 10), pady=10, sticky="ew")
