...
enable_button = ctk.CTkButton(button_frame, text="Enable Form Access", command=enable_access,fg_color="#264D61",hover_color="#2F5E87",height = 30,corner_radius = 15)
enable_button.grid(row=0, column=2, padx=(5, 5), pady=10, sticky="news")

disable_button = ctk.CTkButton(button_frame, text="Disable Form Access", command=disable_access,fg_color="#264D61",hover_color="#2F5E87",height = 30,corner_radius = 15)
disable_button.grid(row=0, column=3, padx=(5, 5), pady=10, sticky="news")

#edit buttons.........

remove_all_button = ctk.CTkButton(button_frame, text="Remove",fg_color="#264D61",hover_color="#2F5E87",height = 30,corner_radius = 15)
remove_all_button.grid(row=0, column=4, padx=(5, 5), pady=10, sticky="news")
...
remove_rows_button.grid(row=0, column=5, padx=(5, 10), pady=10, sticky="news")
