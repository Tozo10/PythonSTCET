...
terms_check = ctk.CTkCheckBox(terms_frame, text="I accept the terms & conditions",checkmark_color="#264d61",fg_color = "#EBF8FF",hover_color = "#2F5E87")
...
if __name__ == "__main__":
    ...
    submit.grid(row=4, column=0, padx=(15,7.5), pady=13, sticky="ew")
    ...
    reset.grid(row=4, column=1, padx=(7.5,15), pady=13, sticky="ew")
