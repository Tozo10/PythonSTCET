...
photo = tkinter.PhotoImage(file = 'STCET-Logo1.png')

p_label = ctk.CTkLabel( window,image = photo,text = " ")
...
relegion_label = ctk.CTkLabel(address_frame,text="Relegion",font=ctk.CTkFont(family = "Times New Roman" ,weight="bold",size = 15))
relegion_label.grid(row = 2,column = 0)
relegion_combo = ctk.CTkComboBox(address_frame,values=["Hinduism","Muslim"])
...
term_label = ctk.CTkLabel(terms_frame,text="Terms & Conditions",font=ctk.CTkFont(family = "Times New Roman" ,weight="bold",size = 15))
...
submit = ctk.CTkButton(frame, text="SUBMIT", command=submit_action)
submit.grid(row=4, column=0, padx=(50, 10), pady=(10, 10), sticky="news")
reset = ctk.CTkButton(frame, text="RESET", command=reset_action)
